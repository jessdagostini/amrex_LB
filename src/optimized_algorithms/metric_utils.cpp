...
char algorithms[7][40] = {"Knapsack", "Karmarkar-Karp", "SFC", "SFC+Painter", "SFC+Knapsack","Painter+Knapsack"};
char metrics[3][40] = {"Efficiency", "Time", "Memory"};
